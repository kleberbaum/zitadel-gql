...
const (
	...
	PermissionProjectAppRegisterDynamic = "project.app.register_dynamic"
	...
	PermissionGroupGrantWrite           = "group.grant.write"
	PermissionGroupGrantRead            = "group.grant.read"
	PermissionGroupGrantDelete          = "group.grant.delete"
)
